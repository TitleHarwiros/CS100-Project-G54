...
function getValuetoResult(){
  ...
  msg += '<p>Student ID : '+ stid.value +'</p>'
  msg += '<p>Date of Birth : '+ birth.value +'</p>'
  msg += '<p>University Email : '+ mail.value +'</p>'
  msg += '<p>Mobile Number : '+ mobilenum.value +'</p>'
  msg += '<p>Gender : '+ gen.value +'</p>'
  msg += '<p>FACULTIES / COLLEGES : '+ fact.value +'</p>'
  msg += '<p>Type of Work/Activity :'+ type.value +'</p>'
  msg += '<p>Academic Year :'+ year.value +'</p>'
  msg += '<p>Semester :'+ semester.value +'</p>'
  msg += '<p>Start Date/Time :'+ start.value +'</p>'
  msg += '<p>End Date/Time :'+ end.value +'</p>'
  msg += '<p>Location :'+ location.value +'</p>'
  msg += '<p>Activity :'+ activity.value +'</p>'
